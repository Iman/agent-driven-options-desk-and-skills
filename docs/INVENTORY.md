...
### shell/tests (335 test functions)
...
- `shell/tests/test_documented_counts.py`: 18
...
55 modules, 12519 lines of source, 150 public functions, 14 public classes, 626 test functions.
