...
Generated by `scripts/inventory.py` on 2026-09-02. Do not edit by hand: run `python3 scripts/refresh.py` and it is rewritten.
...
Roughly 1516 tokens in SKILL.md. Bundled: `.DS_Store`, `reference.md`, `workflows/evaluate-a-rule.md`.
...
Roughly 1841 tokens in SKILL.md. Bundled: `.DS_Store`, `reference.md`, `scripts/check_artifact.py`, `workflows/pull-and-grade.md`.
...
Roughly 1335 tokens in SKILL.md. Bundled: `.DS_Store`, `reference.md`, `workflows/read-the-book.md`.
...
Roughly 1493 tokens in SKILL.md. Bundled: `.DS_Store`, `reference.md`, `workflows/choose-a-structure.md`.
...
### shell/tests (401 test functions)
...
- `shell/tests/test_installer.py`: 24
...
- `shell/tests/test_packaging.py`: 13
...
56 modules, 14143 lines of source, 159 public functions, 14 public classes, 738 test functions.
