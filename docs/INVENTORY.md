...
Generated by `scripts/inventory.py` on 2026-09-01. Do not edit by hand: run `python3 scripts/refresh.py` and it is rewritten.
...
### shell/tests (396 test functions)
...
56 modules, 14143 lines of source, 159 public functions, 14 public classes, 733 test functions.
