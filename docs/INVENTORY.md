...
### shell/tests (306 test functions)
...
- `shell/tests/test_documented_counts.py`: 12
...
55 modules, 12519 lines of source, 150 public functions, 14 public classes, 597 test functions.
