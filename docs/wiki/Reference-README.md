# Project reference: preserved edition

[Architecture](Architecture.md) | [Current installation guide](Skill-Installation.md) | [Guide home](Home.md)

This page preserves the complete `README.md` from [revision `9626273`](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/README.md).
...
[![Licence: PolyForm Noncommercial 1.0.0](https://img.shields.io/badge/licence-PolyForm%20Noncommercial%201.0.0-blue)](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/LICENSE)
[![Tests](https://img.shields.io/badge/tests-1037%20passing%2C%200%20skipped-brightgreen)](#development)
[![Mutation testing](https://img.shields.io/badge/mutations-99%20run%2C%200%20survived-brightgreen)](#development)
[![Python](https://img.shields.io/badge/python-3.11%2B-blue)](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/INSTALL.md)
[![Runtimes](https://img.shields.io/badge/runs%20in-Claude%20Code%20%7C%20Codex%20%7C%20ChatGPT-informational)](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/INSTALL.md)
...
container, are in [INSTALL.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/INSTALL.md).
...
![All twenty-three structures on one SPY expiry, ranked by model expected profit per unit of capital at risk, with the degradation banner the run itself produced](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-comparison.png)
...
> [DISCLAIMER.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/DISCLAIMER.md) first.

Free for any noncommercial purpose. Commercial use needs a written
agreement: see [LICENSES.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/LICENSES.md).
[Contributing](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/CONTRIBUTING.md) ·
[Backlog](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/docs/BACKLOG.md) ·
[Code of conduct](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/CODE_OF_CONDUCT.md) ·
[Security](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/SECURITY.md)
...
the portal. See [the submission pack](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/docs/SUBMISSION.md) for listing text,
...
in [docs/SCREENSHOTS.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/docs/SCREENSHOTS.md), captured from one live run
...
![The pipeline: provider or file to chain, greeks and exposure; chain to strategy, comparison and forward ledger; daily closes to simulation and backtest](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-pipeline.png)
...
![Dealer gamma exposure by strike, cumulative exposure and the flip, open interest, the max pain profile, and the printed arithmetic behind them](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-positioning.png)
...
![Implied volatility by strike and expiry, the smile with 25-delta wings marked, and delta, gamma, vega and theta curves](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-volatility.png)
...
![The composite ranking with its formula, its components, and the model, simulation and history columns side by side](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-composite.png)
...
![The two-expiry structures with their delta ratios and givebacks](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-time-spreads.png)
...
![The structure picker, the plan's numbers, the payoff at expiry with spot, breakevens and the expected move, and the leg table](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-structures.png)
...
![The graded contract ladder, all structures overlaid on one payoff axis, and a scatter of probability against expected return](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-ladder.png)
...
![The posterior predictive fan, terminal distribution, posterior parameter table with R-hat and ESS, realised against implied per structure, and per-structure profit distributions](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-simulation.png)
...
![The backtest statistics table, equity curve, drawdown from peak, and the per-trade outcome distribution](https://raw.githubusercontent.com/Iman/agent-driven-options-desk-and-skills/9626273b5ea0f3374c48d3424605a57377473359/docs/screenshots/dashboard-backtest.png)
...
```
./shell/.venv/bin/python -m pytest -q          # 1037 tests
```
...
./shell/.venv/bin/python -m pytest shell/tests -q     # 521 tests
...
```
python3 scripts/mutate.py           ninety-nine mutations, killed or survived
...
The lesson is in [LOOPS.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/LOOPS.md) as a fourth kind of loop, and the
work it left behind is in [docs/BACKLOG.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/docs/BACKLOG.md). The short
...
Full detail in [LICENSES.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/LICENSES.md), provenance of every borrowed
line in [THIRD-PARTY.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/THIRD-PARTY.md), and contribution terms in
[CLA.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/CLA.md).

Read [DISCLAIMER.md](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/DISCLAIMER.md). It states that this is software
