...
Generated by `scripts/inventory.py` on 2026-09-08. Do not edit by hand: run `python3 scripts/refresh.py` and it is rewritten.
...
Roughly 1875 tokens in SKILL.md. Bundled: `.DS_Store`, `reference.md`, `workflows/run-a-projection.md`.
