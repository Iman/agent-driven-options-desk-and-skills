# Earlier FAQ: preserved edition

[Architecture](Architecture.md) | [Current installation guide](Skill-Installation.md) | [Guide home](Home.md)

This page preserves the complete `FAQ.md` from [revision `9626273`](https://github.com/Iman/agent-driven-options-desk-and-skills/blob/9626273b5ea0f3374c48d3424605a57377473359/FAQ.md).
